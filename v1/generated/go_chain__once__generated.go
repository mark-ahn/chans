...
type Chain struct{ core.Chainable }

func WithChain(chain core.Chainable) *Chain {
	return &Chain{Chainable: chain}
}

func (__ *Chain) CaseRecv(ch interface{}, f func(v interface{}, ok bool) core.CaseControl, onEvent func(core.CaseResult)) *Chain {
	__.AddThread(1)
	go func() {
		defer __.DoneThread()
...
func (__ *Chain) CaseSend(ch interface{}, v interface{}, f func(v interface{}, ok bool, sent core.CaseResult), elseCh interface{}) *Chain {
	__.AddThread(1)
	go func() {
		defer __.DoneThread()
...
func (__ *Chain) Connect(recv interface{}, send interface{}) error {
